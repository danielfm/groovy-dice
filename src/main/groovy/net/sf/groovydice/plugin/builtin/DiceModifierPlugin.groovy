...
class DiceModifierPlugin {
     ...
     * <pre>
     * 3.d.to_every_die         // [1,3,5] -> Number: 8 , Condition: null
     * 3.d.to_each_die_if{it>3} // [1,3,5] -> Number: 8 , Condition: {it>3}
     * 3.d + 1.to_every_die     // [1,3,5] -> Sides: 6 , Dice: [2,4,6] , Sum: 12
     * 3.d - 1.to_every_die     // [1,3,5] -> Sides: 6 , Dice: [0,2,4] , Sum: 6
     * 3.d * 2.to_every_die     // [1,3,5] -> Sides: 6 , Dice: [2,6,10] , Sum: 18
     * 3.d / 2.to_every_die     // [1,3,5] -> Sides: 6 , Dice: [0.5,1.5,3] , Sum: 5
     * 3.d ** 2.to_every_die    // [1,3,5] -> Sides: 6 , Dice: [4,16,36] , Sum: 56
     * 3.d % 3.to_every_die     // [1,3,5] -> Sides: 6 , Dice: [2,1,0] , Sum: 3
     * 1.to_every_die           // -> Number: 1 , Condition: null
     * 1.to_each_die_if{it>3}   // -> Number: 1 , Condition: {it>3}
     * </pre>
