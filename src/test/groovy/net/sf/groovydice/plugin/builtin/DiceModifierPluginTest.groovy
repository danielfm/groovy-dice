...
class DiceModifierPluginTest {
    ...
    @Test
    void numberToEveryDie() {
        def modifier = 1.to_every_die
    ...
    @Test
    void diceRollToEveryDie() {
        def modifier = new DiceRollingCommand(allDice:[1,2,3,4]).to_every_die
    ...
    @Test
    void numberToEachDieIf() {
        def modifier = 1.to_each_die_if('condition')
    ...
    @Test
    void numberToEachDieIfUsingDiceRoll() {
        def modifier = 1.to_each_die_if(new DiceRollingCommand(allDice:[1,2,3]))
    ...
    @Test
    void diceRollToEachDieIfUsingDiceRoll() {
        def modifier = new DiceRollingCommand(allDice:[1,2,3,4])
            .to_each_die_if(new DiceRollingCommand(allDice:[1,2,3]))
